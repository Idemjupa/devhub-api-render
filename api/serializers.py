...
from .models import (
    Category,Skill,Company,Location, Candidate, Type, Job, JobSkill
)
...
class JobSkillCreateSeralizer(serializers.ModelSerializer):
        class Meta:
              model= JobSkill
              fields=['skill']

class JobCreateSerializer(serializers.ModelSerializer):
        skills=JobSkillCreateSeralizer(many=True)
        class Meta:
            model = Job
            fields = ['image', 'title','salary','company', 'type','category','location','status','experience_year', 'skills']
